  ...
  implements OnInit, AfterViewInit
{
  ...
  notifications: any[] = [
    ...
    {
      userImg: "assets/images/user/user3.png",
      userName: "John Doe",
      time: "3 hours ago",
      message: "kindly help me for code.",
    },
    {
      userImg: "assets/images/user/user4.png",
      userName: "Ashton Cox",
      time: "5 hours ago",
      message: "Lets break for lunch...",
    },
    {
      userImg: "assets/images/user/user5.png",
      userName: "Sarah Smith",
      time: "14 mins ago",
      message: "Please check your mail",
    },
    {
      userImg: "assets/images/user/user6.png",
      userName: "Airi Satou",
      time: "22 mins ago",
      message: "Work Completed !!!",
    },
    {
      userImg: "assets/images/user/user7.png",
      userName: "John Doe",
      time: "3 hours ago",
      message: "kindly help me for code.",
    },
